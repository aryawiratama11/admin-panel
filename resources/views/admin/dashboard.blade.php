                ...
                <div class="d-flex flex-wrap align-items-center mb-10">
                    ...
                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                        ...
                        <span class="text-muted font-weight-bold font-size-sm">
                            Created by: <span
                                class="text-primary font-weight-bold">CoreAd</span>
                        </span>
                    </div>
                    <!--end::Title-->
                            ...
                            <tr>
                                ...
                                <td class="pl-0">
                                    <a href="#"
                                        ...
                                        Simmons</a>
                                    <span
                                        class="text-muted font-weight-bold text-muted d-block">HTML,
                                        JS, ReactJS</span>
                                </td>
                                <td>
                                    <span
                            ...
                            <tr>
                                ...
                                <td class="pl-0">
                                    <a href="#"
                                        ...
                                        Clarcson</a>
                                    <span
                                        class="text-muted font-weight-bold text-muted d-block">C#,
                                        ASP.NET, MS SQL</span>
                                </td>
                                <td>
                                    <span
                            ...
                            <tr>
                                ...
                                <td class="pl-0">
                                    <a href="#"
                                        ...
                                        Wayde</a>
                                    <span
                                        class="text-muted font-weight-bold text-muted d-block">PHP,
                                        Laravel, VueJS</span>
                                </td>
                                <td>
                                    <span
                            ...
                            <tr>
                                ...
                                <td class="pl-0">
                                    <a href="#"
                                        ...
                                        Trump</a>
                                    <span
                                        class="text-muted font-weight-bold text-muted d-block">Python,
        ...
        <a href="#" class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">
                    Shopping Cart</div>
                <div class="font-weight-bold text-inverse-white font-size-sm">Lands, Houses,
                    Ranchos, Farms</div>
            </div>
            <!--end::Body-->
        </a>
        ...
        <a href="#"
            ...
            <div class="card-body">
                ...
                <div class="text-inverse-info font-weight-bolder font-size-h5 mb-2 mt-5">
                    Apartments</div>
                <div class="font-weight-bold text-inverse-info font-size-sm">Flats, Shared
                    Rooms, Duplex</div>
            </div>
            <!--end::Body-->
        </a>
        ...
        <a href="#"
            ...
            <div class="card-body">
                ...
                <div class="text-inverse-dark font-weight-bolder font-size-h5 mb-2 mt-5">
                    Sales Stats</div>
                <div class="font-weight-bold text-inverse-dark font-size-sm">50% Increased
                    for FY20</div>
            </div>
            <!--end::Body-->
        </a>
            ...
            <table class="table table-head-custom table-vertical-center"
                ...
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th style="min-width: 150px"><span class="text-primary">Data &
                                status</span>
                            <span class="svg-icon svg-icon-sm svg-icon-primary">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Down-2.svg--><svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                    height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none"
        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-body pt-0">
                ...
                <div class="d-flex align-items-center mb-9 bg-light-warning rounded p-5">
                    ...
                    <!--begin::Lable-->
                    <span
                        class="font-weight-bolder text-warning py-1 font-size-lg">+28%</span>
                    <!--end::Lable-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-center bg-light-success rounded p-5 mb-9">
                    ...
                    <!--begin::Lable-->
                    <span
                        class="font-weight-bolder text-success py-1 font-size-lg">+50%</span>
                    <!--end::Lable-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-9">
                    ...
                    <!--begin::Lable-->
                    <span
                        class="font-weight-bolder text-danger py-1 font-size-lg">-27%</span>
                    <!--end::Lable-->
                </div>
                <!--end::Item-->
